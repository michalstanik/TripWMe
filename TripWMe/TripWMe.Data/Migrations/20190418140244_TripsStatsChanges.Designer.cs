...
namespace TripWMe.Data.Migrations
{
    ...
    [Migration("20190418140244_TripsStatsChanges")]
    partial class TripsStatsChanges
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TripWMe.Domain.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TripWMe.Domain.TripStats", b =>
                {
                    b.Property<int>("TripId");
            ...
            modelBuilder.Entity("TripWMe.Domain.TripStats", b =>
                {
                    b.HasOne("TripWMe.Domain.Trip")
                        .WithOne("TripStats")
                        .HasForeignKey("TripWMe.Domain.TripStats", "TripId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
